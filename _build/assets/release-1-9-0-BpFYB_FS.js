...
`,n(e.h2,{id:"background-synchronization-improvements-and-system-tray",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#background-synchronization-improvements-and-system-tray",get children(){return n(e.span,{className:"icon icon-link"})}}),"Background Synchronization Improvements and System Tray"]}}),`
...
`,n(e.h2,{id:"e-mail-aliases",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#e-mail-aliases",get children(){return n(e.span,{className:"icon icon-link"})}}),"E-mail Aliases"]}}),`
...
`,n(e.h2,{id:"sender-avatars",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#sender-avatars",get children(){return n(e.span,{className:"icon icon-link"})}}),"Sender Avatars"]}}),`
...
`,n(e.h2,{id:"ui-improvements",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ui-improvements",get children(){return n(e.span,{className:"icon icon-link"})}}),"UI Improvements"]}}),`
`,n(e.h3,{id:"mail-list-splitter-by-tiktack",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#mail-list-splitter-by-tiktack",get children(){return n(e.span,{className:"icon icon-link"})}}),"Mail list splitter (by ",n(e.a,{href:"https://github.com/Tiktack",children:"Tiktack"}),")"]}}),`
...
`,n(e.h3,{id:"removed-action-toolbar-by-tiktack",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#removed-action-toolbar-by-tiktack",get children(){return n(e.span,{className:"icon icon-link"})}}),"Removed action toolbar (by ",n(e.a,{href:"https://github.com/Tiktack",children:"Tiktack"}),")"]}}),`
...
`,n(e.h3,{id:"new-conversation-thread-view",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#new-conversation-thread-view",get children(){return n(e.span,{className:"icon icon-link"})}}),"New conversation thread view"]}}),`
...
`,n(e.h2,{id:"bugfixes",get children(){return[n(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#bugfixes",get children(){return n(e.span,{className:"icon icon-link"})}}),"Bugfixes"]}}),`
...
`]}})]}function c(i={}){const{wrapper:e}={...t(),...i.components};return e?n(e,r(i,{get children(){return n(a,i)}})):a(i)}export{c as default,l as frontmatter};
